...
run them and waits until they report healthy; the rest of the stack (chain state, one-shot
init services, volumes) stays up, so you skip the slow contract-deploy + registration boot:
